...
plot_forest(
  ...
  resp_vars = "SR",
  xlim = c(-80, 40),
  xticks = seq(-80, 40, by = 20),
  var_groups = c("Climate", "Forest_type", "Recovery", "Residue", "Severity"),
...
plot_forest(
  ...
  resp_vars = "Rh",
  xlim = c(-60, 80),
  xticks = seq(-60, 80, by = 20),
  var_groups = c("Climate", "Forest_type", "Recovery", "Residue"),
...
plot_forest(
  ...
  var_groups = c("Severity", "Recovery"),
...
plot_forest(
  ...
  var_groups = c("Climate", "Forest_type", "Recovery"),
...
plot_forest(
  ...
  xlim = c(-60, 80),
  xticks = seq(-60, 80, by = 20),
  var_groups = c("Climate", "Forest_type", "Residue", "Severity", "Recovery"),
...
plot_forest(
  ...
  xlim = c(-40, 60),
  xticks = seq(-40, 60, by = 20),
  var_groups = c("Climate", "Forest", "Severity", "Recovery"),
...
plot_forest(
  ...
  resp_vars = "TN",
  xlim = c(-70, 90),
  xticks = seq(-70, 90, by = 40),
  var_groups = c("Climate", "Severity", "Recovery"),
...
plot_forest(
  ...
  xlim = c(-80, 40),
  xticks = seq(-80, 40, by = 20),
  var_groups = c("Recovery", "Severity"),
...
plot_forest(
  ...
  var_groups = c("Climate", "Forest", "Recovery", "Residue", "Severity"),
