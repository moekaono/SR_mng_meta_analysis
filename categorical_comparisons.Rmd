...
CC_Climate_Ra <- aov(ln_Ra ~ Climate_zone, data = CC %>% filter(Climate_zone %in% c("Subtropical", "Temperate")))
...
cat_graph <- function(df, Var_order){
  ...
  geom_text(aes(
    ...
    vjust = 0.5, size = 4) +
  geom_text(aes(
    x = Intercept_Upper_pct_change + 5,
    y = factor(Var_kind, levels = Var_order),
    label = significant
    ),
    vjust = 0.5, size = 4) +
...
# Turn off x-axis text and ticks for all but the last plot
p_CC_Climate_SR  <- p_CC_Climate_SR + theme(axis.text.x = element_blank(),
                                            axis.ticks.x = element_blank(),
                                            axis.title.x = element_blank())
p_CC_Forest_SR   <- p_CC_Forest_SR + theme(axis.text.x = element_blank(),
                                           axis.ticks.x = element_blank(),
                                           axis.title.x = element_blank())
p_CC_Season_SR   <- p_CC_Season_SR + theme(axis.text.x = element_blank(),
                                           axis.ticks.x = element_blank(),
                                           axis.title.x = element_blank())
p_CC_Severity_SR <- p_CC_Severity_SR + theme(axis.text.x = element_blank(),
                                             axis.ticks.x = element_blank(),
                                             axis.title.x = element_blank())
...
(p_CC_Climate_SR / 
 ...
 p_CC_Severity_SR / 
 p_CC_Residue_SR) +
  plot_layout(heights = c(1.5, .6, 1.2, 0.9, 0.6), guides = "collect")
...
# Turn off x-axis text and ticks for all but the last plot
p_TH_Climate_SR  <- p_TH_Climate_SR + theme(axis.text.x = element_blank(),
                                            axis.ticks.x = element_blank(),
                                            axis.title.x = element_blank())
p_TH_Forest_SR   <- p_TH_Forest_SR + theme(axis.text.x = element_blank(),
                                           axis.ticks.x = element_blank(),
                                           axis.title.x = element_blank())
p_TH_Season_SR   <- p_TH_Season_SR + theme(axis.text.x = element_blank(),
                                           axis.ticks.x = element_blank(),
                                           axis.title.x = element_blank())
p_TH_Severity_SR <- p_TH_Severity_SR + theme(axis.text.x = element_blank(),
                                             axis.ticks.x = element_blank(),
                                             axis.title.x = element_blank())
...
(p_TH_Climate_SR / 
 ...
 p_TH_Severity_SR / 
 p_TH_Residue_SR) +
  plot_layout(heights = c(.6, .6, 1.2, 0.9, 0.6), guides = "collect")
```
...
p_PB_Repeat_SR <- 
  cat_graph(
    ...
    Var_order = rev(c("Repeat", "Single"))
    )


# Turn off x-axis text and ticks for all but the last plot
p_PB_Climate_SR  <- p_PB_Climate_SR + theme(axis.text.x = element_blank(),
                                            axis.ticks.x = element_blank(),
                                            axis.title.x = element_blank())
p_PB_Forest_SR   <- p_PB_Forest_SR + theme(axis.text.x = element_blank(),
                                           axis.ticks.x = element_blank(),
                                           axis.title.x = element_blank())
p_PB_Season_SR   <- p_PB_Season_SR + theme(axis.text.x = element_blank(),
                                           axis.ticks.x = element_blank(),
                                           axis.title.x = element_blank())
...
(p_PB_Climate_SR / 
 ...
 p_PB_Season_SR / 
 p_PB_Repeat_SR) +
  plot_layout(heights = c(1.2, .6, 0.9, 0.6), guides = "collect")
...
# Turn off x-axis text and ticks for all but the last plot
p_CC_Climate_Rh  <- p_CC_Climate_Rh + theme(axis.text.x = element_blank(),
                                            axis.ticks.x = element_blank(),
                                            axis.title.x = element_blank())
p_CC_Forest_Rh   <- p_CC_Forest_Rh + theme(axis.text.x = element_blank(),
                                           axis.ticks.x = element_blank(),
                                           axis.title.x = element_blank())
p_CC_Climate_Ra  <- p_CC_Climate_Ra + theme(axis.text.x = element_blank(),
                                            axis.ticks.x = element_blank(),
                                            axis.title.x = element_blank())
...
p_TH_Season_Rh <- 
  cat_graph(
    plot_cat_summary %>% filter(Resp == "Rh", Var == "Season", Management == "Thinning"), 
    Var_order = rev(c("Spring", "Summer", "Fall", "Winter"))
    )
...
p_TH_Season_Rh   <- p_TH_Season_Rh + theme(axis.text.x = element_blank(),
                                           axis.ticks.x = element_blank(),
                                           axis.title.x = element_blank())
p_TH_Severity_Rh <- p_TH_Severity_Rh + theme(axis.text.x = element_blank(),
                                             axis.ticks.x = element_blank(),
                                             axis.title.x = element_blank())
...
(p_TH_Season_Rh / 
 p_TH_Severity_Rh / 
 p_TH_Severity_Ra) +
  plot_layout(heights = c(.6, .9, 0.9), guides = "collect")
